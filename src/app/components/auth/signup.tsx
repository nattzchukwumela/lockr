...
function SignUp() {
  ...
  const handleSubmit = async () => {
    if (!isPasswordless && password !== confirmPassword) {
      alert("Passwords do not match");
      return;
    }
    if (isPasswordless) {
      console.log("Passwordless signup with:", name, email);
    } else {
      console.log("Password signup with:", name, email, password);
      try {
        ...
        console.log(err || "something done spoil for backend");
      }
    }
  };
        ...
        <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-slate-700 p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full px-4 py-3 bg-slate-900/50 hover:bg-slate-900 border border-slate-600 text-white rounded-lg transition-colors flex items-center justify-center gap-3"
            >
